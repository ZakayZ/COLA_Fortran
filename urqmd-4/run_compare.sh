...
# 2. Run pure UrQMD -> build/urqmd_pure_output/file16
./run_urqmd_pure.sh
echo "  -> build/urqmd_pure_output/file16"

# 3. Compare COLA vs pure UrQMD
python3 "$SCRIPT_DIR/compare_outputs.py" cola_particles.txt build/urqmd_pure_output/file16
