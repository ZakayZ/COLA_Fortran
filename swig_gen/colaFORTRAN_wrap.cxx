...
SWIGINTERN std::pair< std::string,std::string > const &std_vector_Sl_std_pair_Sl_std_string_Sc_std_string_Sg__Sg__get(std::vector< std::pair< std::string,std::string > > *self,std::vector< std::pair< std::string,std::string > >::size_type index){
        SWIG_check_range(index, self->size(),
                         "std::vector<""std::pair< std::string,std::string >" ">::get",
                         return self->front());
        return (*self)[index];
      }
SWIGINTERN void std_vector_Sl_std_pair_Sl_std_string_Sc_std_string_Sg__Sg__insert(std::vector< std::pair< std::string,std::string > > *self,std::vector< std::pair< std::string,std::string > >::size_type index,std::pair< std::string,std::string > const &v){
        SWIG_check_range(index, self->size() + 1,
                         "std::vector<""std::pair< std::string,std::string >" ">::insert",
                         return);
        self->insert(self->begin() + index, v);
      }
SWIGINTERN void std_vector_Sl_std_pair_Sl_std_string_Sc_std_string_Sg__Sg__erase__SWIG_0(std::vector< std::pair< std::string,std::string > > *self,std::vector< std::pair< std::string,std::string > >::size_type index){
        SWIG_check_range(index, self->size(),
                         "std::vector<""std::pair< std::string,std::string >" ">::remove",
                         return);
        self->erase(self->begin() + index);
      }
SWIGINTERN void std_vector_Sl_std_pair_Sl_std_string_Sc_std_string_Sg__Sg__erase__SWIG_1(std::vector< std::pair< std::string,std::string > > *self,std::vector< std::pair< std::string,std::string > >::size_type start_index,std::vector< std::pair< std::string,std::string > >::size_type stop_index){
        SWIG_check_range(start_index, stop_index + 1,
                         "std::vector<""std::pair< std::string,std::string >" ">::remove_range",
                         return);
...
SWIGINTERN std::pair< std::string,std::string > &std_vector_Sl_std_pair_Sl_std_string_Sc_std_string_Sg__Sg__front_ref(std::vector< std::pair< std::string,std::string > > *self){
      return (*self).front();
    }
SWIGINTERN std::pair< std::string,std::string > &std_vector_Sl_std_pair_Sl_std_string_Sc_std_string_Sg__Sg__back_ref(std::vector< std::pair< std::string,std::string > > *self){
      return (*self).back();
    }
SWIGINTERN std::pair< std::string,std::string > &std_vector_Sl_std_pair_Sl_std_string_Sc_std_string_Sg__Sg__get_ref(std::vector< std::pair< std::string,std::string > > *self,std::vector< std::pair< std::string,std::string > >::size_type index){
      SWIG_check_range(index, self->size(),
                       "std::vector<""std::pair< std::string,std::string >" ">::get_ref",
                       return self->front());
      return (*self)[index];
    }
SWIGINTERN void std_vector_Sl_cola_Particle_Sg__set(std::vector< cola::Particle > *self,std::vector< cola::Particle >::size_type index,cola::Particle const &v){
        SWIG_check_range(index, self->size(),
                         "std::vector<""cola::Particle" ">::set",
                         return);
        (*self)[index] = v;
      }
SWIGINTERN cola::Particle const &std_vector_Sl_cola_Particle_Sg__get(std::vector< cola::Particle > *self,std::vector< cola::Particle >::size_type index){
        SWIG_check_range(index, self->size(),
                         "std::vector<""cola::Particle" ">::get",
                         return self->front());
        return (*self)[index];
      }
SWIGINTERN void std_vector_Sl_cola_Particle_Sg__insert(std::vector< cola::Particle > *self,std::vector< cola::Particle >::size_type index,cola::Particle const &v){
        SWIG_check_range(index, self->size() + 1,
                         "std::vector<""cola::Particle" ">::insert",
                         return);
        self->insert(self->begin() + index, v);
      }
SWIGINTERN void std_vector_Sl_cola_Particle_Sg__erase__SWIG_0(std::vector< cola::Particle > *self,std::vector< cola::Particle >::size_type index){
        SWIG_check_range(index, self->size(),
                         "std::vector<""cola::Particle" ">::remove",
                         return);
        self->erase(self->begin() + index);
      }
SWIGINTERN void std_vector_Sl_cola_Particle_Sg__erase__SWIG_1(std::vector< cola::Particle > *self,std::vector< cola::Particle >::size_type start_index,std::vector< cola::Particle >::size_type stop_index){
        SWIG_check_range(start_index, stop_index + 1,
                         "std::vector<""cola::Particle" ">::remove_range",
                         return);
        SWIG_check_range(stop_index, self->size() + 1,
                         "std::vector<""cola::Particle" ">::remove_range",
                         return);
...
SWIGINTERN cola::Particle &std_vector_Sl_cola_Particle_Sg__get_ref(std::vector< cola::Particle > *self,std::vector< cola::Particle >::size_type index){
      SWIG_check_range(index, self->size(),
                       "std::vector<""cola::Particle" ">::get_ref",
                       return self->front());
      return (*self)[index];
    }
extern "C" {
...
SWIGEXPORT SwigClassWrapper _wrap_Particle_GetAZ(SwigClassWrapper *farg1) {
  ...
  SWIG_check_nonnull(farg1->cptr, "cola::Particle const *", "Particle", "cola::Particle::GetAZ() const", return SwigClassWrapper_uninitialized());
...
SWIGEXPORT SwigClassWrapper _wrap_EventData_particles_get(SwigClassWrapper *farg1) {
  ...
  SWIG_check_nonnull(farg1->cptr, "cola::EventData *", "EventData", "cola::EventData::particles", return SwigClassWrapper_uninitialized());
  arg1 = (cola::EventData *)farg1->cptr;
